...
import { updateCategoryAction } from '@/app/admin/actions/categories/updateCategory';
...
export default function EditCategoryClient({ category, categories, categoryId }: EditCategoryClientProps) {
